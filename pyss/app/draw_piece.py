...
def create_rook_shape():
    ...
    shape.append(arcade.create_rectangle_filled(
        0, 0, 50, 50, arcade.color.WHITE))
    shape.append(arcade.create_rectangle_filled(
        0, 0, 50, 10, arcade.color.BLACK))
    shape.append(arcade.create_rectangle_filled(
        0, 0, 10, 50, arcade.color.BLACK))
    return shape
...
def create_knight_shape():
    ...
    shape.append(arcade.create_rectangle_filled(
        0, 0, 50, 50, arcade.color.WHITE))
    shape.append(arcade.create_ellipse_filled(
        0, 0, 50, 50, arcade.color.BLACK))
    return shape
...
def load_pieces():
    ...
    def build_sprite(x, y): return arcade.Sprite(
        filename=filename,
        image_x=x,
        image_y=y,
